let slice = function () {
	...
	let begin = (parseInt(arguments[1], 10) < 0) ? (array.length + parseInt(arguments[1], 10)) : parseInt(arguments[1], 10);

	let end = (typeof arguments[2] !== 'undefined') ? parseInt(arguments[2], 10) : array.length - 1;
